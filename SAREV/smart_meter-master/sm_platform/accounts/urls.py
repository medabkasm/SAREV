...
urlpatterns = [
    ...
    path('<str:username>/password_change/',
            auth_views.PasswordChangeView.as_view(template_name = "accounts/changePassword.html",
                success_url ='done/'),
                                name='password_change'),

    path('<str:username>/password_change/done/',
            auth_views.PasswordChangeDoneView.as_view(template_name = "accounts/changePasswordDone.html") ,
                                                name='password_change_done'),
    path('<str:username>/delete_account/confirm/',delete_account_confirm, name = 'delete_account_confirm' ),
    path('<str:username>/delete_account/',delete_account , name = 'delete_account'),
